...
export const courses = [
  // --- NEW VLSI COURSE: Design Verification ---
  {
    ...
    image: "/homePageCoreCourses/image1.png",
    modules: [
  ...
  // --- NEW VLSI COURSE: Physical Design ---
  {
    ...
    image: "/homePageCoreCourses/image2.png",
    modules: [
  ...
  // --- UPDATED FPGA COURSE: Using the new detailed list you provided ---
  {
    ...
    image: "/homePageCoreCourses/image3.png",
    modules: [
  ...
  // --- Original courses remain below ---
  {
    ...
    image: "/homePageCoreCourses/image4.png",
    modules: [
  ...
  },
  {
    ...
    image: "/homePageCoreCourses/image5.png",
    modules: [
